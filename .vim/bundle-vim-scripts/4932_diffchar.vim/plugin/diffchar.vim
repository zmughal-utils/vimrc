...
function! s:ApplyIntDiffAlgorithm(sed)
	...
	" set those replaced lines
	if !exists("t:DChar.vdl") | let t:DChar.vdl = {} | endif
	if getbufline(t:DChar.buf[1], r1[0])[0] ==# f1[r1[0] - 1] &&
		\getbufline(t:DChar.buf[2], r2[0])[0] ==# f2[r2[0] - 1]
		let [t:DChar.vdl[1], t:DChar.vdl[2]] = [r1, r2]
	elseif getbufline(t:DChar.buf[2], r1[0])[0] ==# f1[r1[0] - 1] &&
		\getbufline(t:DChar.buf[1], r2[0])[0] ==# f2[r2[0] - 1]
